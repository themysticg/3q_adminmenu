...
RegisterNetEvent('3q_admin/client/fling-player', function()
    FlingPlayer()
end)

RegisterNetEvent("3q_admin/client/drunk", function()
    drunkThread()
end)

RegisterNetEvent("3q_admin/client/animal-attack", function()
    startWildAttack()
end)

RegisterNetEvent("3q_admin/client/set-fire", function()

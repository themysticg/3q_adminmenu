...
QBCore.Functions.CreateCallback('3q_adminmenu/server/get-permission', function(Source, Cb)
    local Group = QBCore.Functions.GetPermission(Source)
    Cb(Group)
end)

QBCore.Functions.CreateCallback('3q_adminmenu/server/get-convar', function(source, Cb, ConvarName)
    Cb(GetConvar(ConvarName, 'none'))
end)

QBCore.Functions.CreateCallback('3q_admin/server/get-active-players-in-radius', function(Source, Cb, Coords, Radius)
...
QBCore.Functions.CreateCallback('3q_admin/server/get-bans', function(source, Cb)
    local BanList = {}
...
QBCore.Functions.CreateCallback('3q_admin/server/get-logs', function(source, Cb)
    local LogsList = {}
...
QBCore.Functions.CreateCallback('3q_admin/server/get-players', function(source, Cb)
    local PlayerList = {}
...
QBCore.Functions.CreateCallback('3q_admin/server/get-player-data', function(source, Cb, Identifier)
    local PlayerInfo = {}
    local TPlayer = nil
...
QBCore.Functions.CreateCallback('3q_admin/server/get-date-difference', function(source, Cb, Bans, Type)
    local FilteredBans, BanAmount = GetDateDifference(Type, Bans) 
    Cb(FilteredBans, BanAmount)
end)

QBCore.Functions.CreateCallback("3q_admin/server/create-log", function(source, Cb, Type, Log, Data)
...
RegisterNetEvent("3q_admin/server/try-open-menu", function(KeyPress)
    local src = source
    
    TriggerClientEvent('3q_admin/client/try-open-menu', src, KeyPress)
end)

-- User Commands

RegisterNetEvent("3q_admin/server/unban-player", function(BanId)
    local src = source
...
RegisterNetEvent("3q_admin/server/ban-player", function(ServerId, Expires, Reason)
    local src = source
...
RegisterNetEvent("3q_admin/server/kick-all-players", function(Reason)
    local src = source
...
RegisterNetEvent("3q_admin/server/kick-player", function(ServerId, Reason)
    local src = source
...
RegisterNetEvent("3q_admin/server/set-money", function(ServerId, MoneyType, MoneyAmount)
    local src = source
...
RegisterNetEvent("3q_admin/server/give-money", function(ServerId, MoneyType, MoneyAmount)
    local src = source
...
RegisterNetEvent("3q_admin/server/give-item", function(ServerId, ItemName, ItemAmount)
    local src = source
...
RegisterNetEvent("3q_admin/server/request-gang", function(ServerId, GangName)
    local src = source
...
RegisterNetEvent("3q_admin/server/request-job", function(ServerId, JobName)
    local src = source
...
RegisterNetEvent('3q_admin/server/start-spectate', function(ServerId)
    local src = source
...
RegisterNetEvent('3q_admin/server/stop-spectate', function()
    local src = source
...
RegisterNetEvent("3q_admin/server/drunk", function(ServerId)
    local src = source
    
    local Source = ServerId ~= nil and ServerId or src
    TriggerClientEvent('3q_admin/client/drunk', Source)
end)

RegisterNetEvent("3q_admin/server/animal-attack", function(ServerId)
    local src = source
    
    local Source = ServerId ~= nil and ServerId or src
    TriggerClientEvent('3q_admin/client/animal-attack', Source)
end)

RegisterNetEvent("3q_admin/server/set-fire", function(ServerId)
    local src = source
    
    local Source = ServerId ~= nil and ServerId or src
    TriggerClientEvent('3q_admin/client/set-fire', Source)
end)

RegisterNetEvent("3q_admin/server/fling-player", function(ServerId)
    local src = source
    
    local Source = ServerId ~= nil and ServerId or src
    TriggerClientEvent('3q_admin/client/fling-player', Source)
end)

RegisterNetEvent("3q_admin/server/play-sound", function(ServerId, SoundId)
    local src = source
    
    local Source = ServerId ~= nil and ServerId or src
    TriggerClientEvent('3q_admin/client/play-sound', Source, SoundId)
end)

-- Utility Commands

RegisterNetEvent("3q_admin/server/toggle-blips", function()
    local src = source
    ...
    TriggerClientEvent('3q_admin/client/UpdatePlayerBlips', src, BlipData)
end)


RegisterNetEvent("3q_admin/server/teleport-all", function()
    local src = source
    ...
    for k, v in pairs(QBCore.Functions.GetPlayers()) do
        ...
        if SourcePlayer ~= nil and TPlayer ~= nil then 
            if SourcePlayer.PlayerData.citizenid ~= TPlayer.PlayerData.citizenid then
                ...
                TriggerClientEvent('3q_admin/client/teleport-player', v, SourceCoords)
            end
        end
    end
end)

RegisterNetEvent("3q_admin/server/teleport-player", function(ServerId, Type)
    local src = source
    ...
    if Type == 'Goto' then
        ...
        TriggerClientEvent('3q_admin/client/teleport-player', src, TCoords)
    elseif Type == 'Bring' then
        Msg = Lang:t('info.teleported_brought')
        local Coords = GetEntityCoords(GetPlayerPed(src))
        TriggerClientEvent('3q_admin/client/teleport-player', Source, Coords)
    end
    TriggerClientEvent('QBCore:Notify', src, Lang:t('info.teleported', {tpmsg = Msg}), 'success')
end)

RegisterNetEvent("3q_admin/server/chat-say", function(Message)
...
RegisterNetEvent("3q_admin/server/set-environment", function(Weather, Hour, Minute)
    local src = source
...
RegisterNetEvent("3q_admin/server/open-bennys", function(ServerId)
    local src = source
...
RegisterNetEvent("3q_admin/server/kill", function(ServerId)
    local src = source
...
RegisterNetEvent("3q_admin/server/delete-area", function(Type, Radius)
    local src = source
    

    TriggerClientEvent('3q_admin/client/delete-area', src, Type, Radius)
end)

RegisterNetEvent("3q_admin/server/freeze-player", function(ServerId)
    local src = source
    ...
    if TPlayer ~= nil then
        ...
        TriggerClientEvent('3q_admin/client/freeze-player', Source, FrozenPlayers[PData.citizenid])
    end
end)

RegisterNetEvent("3q_admin/server/toggle-infinite-ammo", function(ServerId)
    local src = source
    ...
    if TPlayer ~= nil then
        ...
        TriggerClientEvent('3q_admin/client/toggle-infinite-ammo', Source, AmmoEnabled[PData.citizenid])
    end
end)

RegisterNetEvent("3q_admin/server/toggle-infinite-stamina", function(ServerId)
    local src = source
    ...
    if TPlayer ~= nil then
        ...
        TriggerClientEvent('3q_admin/client/toggle-infinite-stamina', Source, StaminaEnabled[PData.citizenid])
    end
end)

RegisterNetEvent("3q_admin/server/toggle-cloak", function(ServerId)
    local src = source
    ...
    if TPlayer ~= nil then
        ...
        TriggerClientEvent('3q_admin/client/toggle-cloak', Source, CloakEnabled[PData.citizenid])
    end
end)

RegisterNetEvent("3q_admin/server/toggle-godmode", function(ServerId)
    local src = source
    ...
    if TPlayer ~= nil then
        ...
        TriggerClientEvent('3q_admin/client/toggle-godmode', Source, GodmodeEnabled[PData.citizenid])
    end
end)

RegisterNetEvent("3q_admin/server/set-food-drink", function(ServerId)
    local src = source
...
RegisterNetEvent("3q_admin/server/remove-stress", function(ServerId)
    local src = source
...
RegisterNetEvent("3q_admin/server/set-armor", function(ServerId)
    local src = source
...
RegisterNetEvent("3q_admin/server/reset-skin", function(ServerId)
    local src = source
...
RegisterNetEvent("3q_admin/server/set-model", function(ServerId, Model)
    local src = source
    
    local Source = ServerId ~= nil and ServerId or src
    TriggerClientEvent('3q_admin/client/set-model', Source, Model)
end)

RegisterNetEvent("3q_admin/server/revive-all", function()
    local src = source
...
RegisterNetEvent("3q_admin/server/revive-in-distance", function(Radius)
    local src = source
...
RegisterNetEvent("3q_admin/server/revive-target", function(ServerId)
    local src = source
...
RegisterNetEvent("3q_admin/server/open-clothing", function(ServerId)
    local src = source
...
RegisterNetEvent('3q_admin/server/sync-chat-data', function(Type, Data, UpdateDelay)
    ...
    TriggerClientEvent('3q_admin/client/sync-chat-data', -1, Type, Type == 'Staffchat' and Config.StaffChat or Config.Reports, UpdateDelay)
end)

RegisterNetEvent("3q_admin/server/send-chat-report", function(ServerId, Message)
